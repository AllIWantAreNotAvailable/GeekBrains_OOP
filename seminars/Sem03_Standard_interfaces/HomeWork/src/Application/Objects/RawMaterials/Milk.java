...
public class Milk extends RawMaterial {
    public Milk(String name, Float volume, Unit unit, String placeOfOrigin) {
    ...
    public Product getPieceOfProduct(Float volume, Unit unit) throws Exception {
        ...
        if (0 <= newVolume) {
            return new Milk(getName(), volume, unit, getPlaceOfOrigin());
        }
    ...
    public void transferVolume(RawMaterial product, Float volume, Unit unit) throws Exception {
        ...
        if (product != this
                && product instanceof Milk anotherMilk
                && volume != null
                && unit != null) {
            ...
            if (0 <= newVolume) {
                ...
                anotherMilk.setVolume(anotherMilk.getVolume() + volume);
            }
        }
