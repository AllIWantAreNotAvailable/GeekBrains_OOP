...
class ComplexCalcView(View):
    ...
    @staticmethod
    def __input_exception(user_input: str, type_exc: str, example: str):
    ...
    def __operation_input(self, intro: str, validation, ex_out, type_exc: str, example: str) -> str:
        print(intro)
